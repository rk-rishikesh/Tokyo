...
answer:  "India became independent in 1947 … (history.eth v42, 2 sources, reviewed by expert.eth)"`}</Diagram>
          ...
          <div className="mt-6"><Steps steps={[
            { title: 'Give an agent the network', body: <>One MCP server serves every namespace; the agent names one per call.</>, code: `claude mcp add knowledge -e KNOWLEDGE_AGENT=my-agent.eth -- npx -y @k01/mcp` },
