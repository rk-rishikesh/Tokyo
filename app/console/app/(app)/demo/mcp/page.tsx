...
const INSTALL = `claude mcp add knowledge \\
  ...
  -e KNOWLEDGE_AGENT=my-agent.eth \\
...
const SCRIPT: Line[] = [
  { kind: 'cmd', text: 'claude mcp add knowledge -e PINATA_GATEWAY=… -e KNOWLEDGE_AGENT=my-agent.eth -- npx -y @knowledge01/mcp' },
      ...
      <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)]">
        <ol className="space-y-7">
          ...
          <Step n={2} title="Add the server">
            ...
            <p className="text-[13px]">Other clients: command <code className="font-mono">npx</code>, args <code className="font-mono">[&quot;-y&quot;, &quot;@knowledge01/mcp&quot;]</code>, with the same two environment variables.</p>
          </Step>
        ...
        <div className="lg:sticky lg:top-6">
          <Terminal script={SCRIPT} title="claude — knowledge" />
