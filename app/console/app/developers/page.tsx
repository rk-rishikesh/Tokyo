      ...
      <main className="w-full px-5 sm:px-8 lg:px-10">
        ...
        <Section title="Reference">
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ['SDK · @k01/repo', 'Namespace.for · search · get · all · why · history · contribute · observe · remember · update · forget · repo.* for branches, merge, revert, proposals, policy, sources'],
